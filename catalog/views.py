...
def index(request):
    ...
    num_wordMente=Book.objects.filter(summary__contains = "dinero").count()
    ...
    return render(
        ...
        context={'num_books':num_books
                ...
                ,'num_genre':num_genre
                ,'num_wordMente':num_wordMente
                ,'num_visits':num_visits}, # num_visits appended
    )

from django.views import generic
# clases para catalogo y detalle Book
...
# clases para catalogo y detalle Author
